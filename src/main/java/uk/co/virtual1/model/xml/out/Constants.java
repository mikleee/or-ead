...
public class Constants {
    ...
    public final static String END_A = "A";
    public final static String END_B = "B";

    public final static String Y = "Y";
    public final static String N = "N";

    public final static String HOUSING_CABINET = "CABINET";
    public final static String SITE_TYPE_BT = "BT";
    public final static String SITE_TYPE_NON_BT = "Non BT";

    public final static String ADDRESS_TYPE_FULL = "Full";
